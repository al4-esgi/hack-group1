...
export class RestaurantSearchItemDto {
  ...
  @ApiProperty({ example: '48.858237', description: 'Latitude as a decimal string (precision 9, scale 6).' })
  latitude: string;

  @ApiProperty({ example: '2.294481', description: 'Longitude as a decimal string (precision 9, scale 6).' })
  longitude: string;
